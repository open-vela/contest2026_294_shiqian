...
#define ATON_DECUN_MEM_LOW_SET(UNIT, IDX, DATA)  LL_ATON_REG_WRITE(ATON_DECUN_MEM_LOW_ADDR(UNIT, IDX), (DATA))
#endif
...
#define ATON_DECUN_MEM_HIGH_SET(UNIT, IDX, DATA)  LL_ATON_REG_WRITE(ATON_DECUN_MEM_HIGH_ADDR(UNIT, IDX), (DATA))
#endif
...
// assuming that the following macro is used only for IMC tiles (FIXME)
#define ATON_STRSWITCH64_DST_OFFSET(UNIT, IDX) (ATON_STRSWITCH_DSTIMC00_OFFSET + (((IDX)-4U) << 2))
...
#define ATON_ACTIV_ROM0_SET(UNIT, IDX, DATA) LL_ATON_REG_WRITE(ATON_ACTIV_ROM0_ADDR(UNIT, IDX), (DATA))
#define ATON_ACTIV_ROM0_ADDR(UNIT, IDX)      (ATON_ACTIV_BASE(UNIT) + ATON_ACTIV_ROM0_OFFSET(UNIT, IDX))
...
#define ATON_ACTIV_ROM1_AB_SET(UNIT, IDX, DATA) LL_ATON_REG_WRITE(ATON_ACTIV_ROM1_AB_ADDR(UNIT, IDX), (DATA))
...
#define ATON_ACTIV_ROM1_C_SET(UNIT, IDX, DATA) LL_ATON_REG_WRITE(ATON_ACTIV_ROM1_C_ADDR(UNIT, IDX), (DATA))
...
#define ATON_ARITH_COEFF_AB_SET(UNIT, IDX, DATA) LL_ATON_REG_WRITE(ATON_ARITH_COEFF_AB_ADDR(UNIT, IDX), (DATA))
...
#define ATON_ARITH_COEFF_C_SET(UNIT, IDX, DATA) LL_ATON_REG_WRITE(ATON_ARITH_COEFF_C_ADDR(UNIT, IDX), (DATA))
