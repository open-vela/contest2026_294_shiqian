...
extern "C"
{
  ...
  void aton_osal_freertos_pb_lock(void);
  void aton_osal_freertos_pb_unlock(void);
...
#ifndef FREERTOS_HAS_PARALLEL_NETWORKS
#define FREERTOS_HAS_PARALLEL_NETWORKS 1 // there are parallel networks in the application
#warning Using default value `1` for macro `FREERTOS_HAS_PARALLEL_NETWORKS`.
